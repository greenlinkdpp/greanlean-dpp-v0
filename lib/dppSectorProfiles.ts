...
export const DPP_SECTOR_PROFILES: DppSectorProfile[] = [
  ...
  },
  {
    ...
    sectorNameZh: "电子电器",
    categoryCode: "consumer_electronics",
    categoryName: "Consumer electronics",
    categoryNameZh: "消费电子",
    subcategoryCode: "audio_device",
    subcategoryName: "Audio device",
    subcategoryNameZh: "音频设备",
    profileKey: "electronics.consumer.audio.v1",
    name: "Electronics / Consumer electronics / Audio device",
    nameZh: "电子电器 / 消费电子 / 音频设备",
    regulationBasis: "ESPR electronics product group preparation",
    granularityLevels: ["model", "batch", "item"],
  },
];
