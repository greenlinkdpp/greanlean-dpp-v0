...
-- Resolve the product first, then load its current publication pointer.
-- Keeping these steps separate avoids a silent null result from the original
-- combined identifier, alias, pointer and publication query.
