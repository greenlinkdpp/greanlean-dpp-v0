  ...
  async function syncDemoData() {
    ...
    try {
      ...
      await insertRows(supabase, "product_certificates", [
        ...
        { product_id: flooringId, certificate_name: "EU Declaration of Performance", certificate_name_zh: "欧盟性能声明 DoP", certificate_type: "Construction products", certificate_type_zh: "建筑产品", certificate_number: "DOP-WPC-MS140K25B", issuer: "HUANGSHAN MEISEN New Material Co., Ltd.", issue_date: "2026-06-04", expiry_date: "2027-06-03", certificate_url: "/api/declaration?product=demo-wpc-flooring", verification_status: "verified" },
        { product_id: flooringId, certificate_name: "VOC Emission Test Report", certificate_name_zh: "VOC 排放检测报告", certificate_type: "Indoor air quality", certificate_type_zh: "室内空气质量", certificate_number: "VOC-WPC-2026-018", issuer: "Demo Building Materials Testing Institute", issue_date: "2026-05-12", expiry_date: "2027-05-11", certificate_url: "/api/chemical-document?type=heavy-metals&product=demo-wpc-flooring", verification_status: "verified" },
      ...
      await insertRows(supabase, "product_documents", [
        ...
        { product_id: flooringId, document_name: "VOC Emission Test Report", document_type: "VOC", file_url: "/api/chemical-document?type=heavy-metals&product=demo-wpc-flooring", file_size: "520 KB", language: "EN", uploaded_by: "greanlean admin", version: "v1.0" },
