  ...
  async function syncDemoData() {
    ...
    try {
      ...
      await insertRows(supabase, "product_esg_metrics", [
        { product_id: earbudsId, carbon_footprint: 6.8, water_usage: 42, energy_consumption: 15.5, waste_generation: 0.22, recycled_content: 18, chemical_management: "RoHS, REACH SVHC, battery MSDS and supplier declarations reviewed.", lca_report_url: "/api/dpp-export?format=pdf&product=demo-wireless-earbuds", methodology: "Screening LCA based on component BOM, battery data, assembly energy and export logistics assumptions.", verified_by: "SGS-CSTC Standards Technical Services Co., Ltd. (Demo)" },
        { product_id: flooringId, carbon_footprint: 12, water_usage: 120, energy_consumption: 15, waste_generation: 0.7, recycled_content: 30, chemical_management: "No SVHC declared. REACH, VOC and ISO9001 evidence are represented from the Excel document list; carbon, electricity, water, VOC and ISO14001 fields are estimated demo assumptions.", lca_report_url: "/api/dpp-export?format=pdf&product=demo-wpc-flooring", methodology: "Estimated screening profile: 12 kg CO2e/m2, 15 kWh electricity, 120 L water, 30% renewable-energy ratio and 70% waste recycling rate; based on WPC decking industry assumptions and supplied product data.", verified_by: "Greanlean demo data review" },
        { product_id: furnitureId, carbon_footprint: 28.6, water_usage: 76, energy_consumption: 58, waste_generation: 1.4, recycled_content: 34, chemical_management: "REACH SVHC, coating heavy metals, textile contact materials and foam additives reviewed.", lca_report_url: "/api/dpp-export?format=pdf&product=demo-office-chair", methodology: "Screening LCA based on steel frame, polymer content, upholstery, assembly energy and sea freight to the EU.", verified_by: "Demo Furniture Testing Institute" },
      ]);
      ...
      await insertRows(supabase, "product_certificates", [
        { product_id: earbudsId, certificate_name: "EU Declaration of Conformity", certificate_name_zh: "欧盟符合性声明", certificate_type: "DoC / CE", certificate_type_zh: "符合性声明 / CE", certificate_number: "CE-DOC-AUDIO-2026-001", issuer: "Greanlean Electronics Demo Manufacturer", issue_date: "2026-06-04", expiry_date: "2027-06-03", certificate_url: "/api/declaration?product=demo-wireless-earbuds", verification_status: "verified" },
        { product_id: earbudsId, certificate_name: "RoHS Restricted Substance Test Report", certificate_name_zh: "RoHS 受限物质检测报告", certificate_type: "Chemical compliance", certificate_type_zh: "化学合规", certificate_number: "ROHS-AUDIO-2026-018", issuer: "SGS-CSTC Standards Technical Services Co., Ltd. (Demo)", issue_date: "2026-05-18", expiry_date: "2027-05-17", certificate_url: "/api/chemical-document?type=heavy-metals&product=demo-wireless-earbuds", verification_status: "verified" },
        { product_id: flooringId, certificate_name: "EU Declaration of Performance", certificate_name_zh: "欧盟性能声明 DoP", certificate_type: "Construction products", certificate_type_zh: "建筑产品", certificate_number: "DOP-MS140K25B-W2605-05", issuer: "HUANGSHAN MEISEN NEW MATERIAL TECHNOLOGY CO., LTD", issue_date: "2026-05-20", expiry_date: "2027-05-19", certificate_url: "/api/declaration?product=demo-wpc-flooring", verification_status: "verified" },
        { product_id: flooringId, certificate_name: "FSC Certificate", certificate_name_zh: "FSC 证书", certificate_type: "Chain of custody", certificate_type_zh: "产销监管链", certificate_number: "BV-COC-154663", issuer: "Bureau Veritas Certification (Demo)", issue_date: "2026-05-20", expiry_date: "2027-05-19", certificate_url: "/api/dpp-export?format=pdf&product=demo-wpc-flooring", verification_status: "verified" },
        { product_id: flooringId, certificate_name: "VOC Test Report", certificate_name_zh: "VOC 检测报告", certificate_type: "Emission test", certificate_type_zh: "排放检测", certificate_number: "VOC-WPC-2026-018", issuer: "Demo Building Materials Testing Institute", issue_date: "2026-05-20", expiry_date: "2027-05-19", certificate_url: "/api/chemical-document?type=heavy-metals&product=demo-wpc-flooring", verification_status: "verified" },
        { product_id: flooringId, certificate_name: "REACH Declaration", certificate_name_zh: "REACH 声明", certificate_type: "Chemical compliance", certificate_type_zh: "化学合规", certificate_number: "REACH-WPC-2026-026", issuer: "Demo Chemical Testing Institute", issue_date: "2026-05-20", expiry_date: "2027-05-19", certificate_url: "/api/chemical-document?type=svhc&product=demo-wpc-flooring", verification_status: "verified" },
        { product_id: flooringId, certificate_name: "ISO9001 Certificate", certificate_name_zh: "ISO9001 证书", certificate_type: "Quality management", certificate_type_zh: "质量管理", certificate_number: "ISO9001-MS140K25B-DEMO", issuer: "Demo QMS Certification Body", issue_date: "2026-05-20", expiry_date: "2027-05-19", certificate_url: "/api/dpp-export?format=pdf&product=demo-wpc-flooring", verification_status: "verified" },
        { product_id: furnitureId, certificate_name: "Furniture Durability Test Report", certificate_name_zh: "家具耐久性测试报告", certificate_type: "Performance", certificate_type_zh: "性能测试", certificate_number: "EN1335-CHAIR-2026-011", issuer: "Demo Furniture Testing Institute", issue_date: "2026-05-16", expiry_date: "2027-05-15", certificate_url: "/api/dpp-export?format=pdf&product=demo-office-chair", verification_status: "verified" },
        { product_id: furnitureId, certificate_name: "REACH SVHC and Heavy Metal Screening", certificate_name_zh: "REACH SVHC 与重金属筛查", certificate_type: "Chemical compliance", certificate_type_zh: "化学合规", certificate_number: "REACH-FURN-2026-024", issuer: "Demo Chemical Testing Institute", issue_date: "2026-05-20", expiry_date: "2027-05-19", certificate_url: "/api/chemical-document?type=svhc&product=demo-office-chair", verification_status: "verified" },
      ]);
      ...
      await insertRows(supabase, "product_digital_identity", [
        ...
        { product_id: flooringId, product_uuid: "51e0f9f3-3c7b-45c0-9b8f-demofloor01", gtin: "06900000000203", style_id: "STYLE-WPC-MS140K25B", batch_id: "W2605-05", serial_id: "TRACE-W2605-05", digital_link_url: "https://www.greanlean.com/p/demo-wpc-flooring", qr_code_id: "QR-DPP-WPC-001", nfc_id: "NFC-RESERVED", rfid_epc: "RFID-PALLET-RESERVED" },
      ...
      await insertRows(supabase, "product_documents", [
        { product_id: earbudsId, document_name: "EU Declaration of Conformity", document_type: "DoC", file_url: "/api/declaration?product=demo-wireless-earbuds", file_size: "360 KB", language: "EN / ZH", uploaded_by: "greanlean admin", version: "v1.0" },
        { product_id: earbudsId, document_name: "Battery MSDS", document_type: "MSDS", file_url: "/api/chemical-document?type=msds&product=demo-wireless-earbuds", file_size: "480 KB", language: "EN", uploaded_by: "greanlean admin", version: "v1.0" },
        { product_id: flooringId, document_name: "EU Declaration of Performance", document_type: "DoP", file_url: "/api/declaration?product=demo-wpc-flooring", file_size: "390 KB", language: "EN / ZH", uploaded_by: "greanlean admin", version: "v1.0" },
        { product_id: flooringId, document_name: "FSC Certificate", document_type: "FSC", file_url: "/api/dpp-export?format=pdf&product=demo-wpc-flooring", file_size: "460 KB", language: "EN", uploaded_by: "greanlean admin", version: "v1.0" },
        { product_id: flooringId, document_name: "REACH Declaration", document_type: "REACH", file_url: "/api/chemical-document?type=svhc&product=demo-wpc-flooring", file_size: "410 KB", language: "EN", uploaded_by: "greanlean admin", version: "v1.0" },
        { product_id: flooringId, document_name: "VOC Test Report", document_type: "VOC", file_url: "/api/chemical-document?type=heavy-metals&product=demo-wpc-flooring", file_size: "520 KB", language: "EN", uploaded_by: "greanlean admin", version: "v1.0" },
        { product_id: flooringId, document_name: "ISO9001 Certificate", document_type: "ISO9001", file_url: "/api/dpp-export?format=pdf&product=demo-wpc-flooring", file_size: "440 KB", language: "EN", uploaded_by: "greanlean admin", version: "v1.0" },
        { product_id: flooringId, document_name: "Installation Guide", document_type: "Installation", file_url: "/api/dpp-export?format=pdf&product=demo-wpc-flooring", file_size: "680 KB", language: "EN / ZH", uploaded_by: "greanlean admin", version: "v1.0" },
        { product_id: flooringId, document_name: "Warranty Document", document_type: "Warranty", file_url: "/api/dpp-export?format=pdf&product=demo-wpc-flooring", file_size: "360 KB", language: "EN / ZH", uploaded_by: "greanlean admin", version: "v1.0" },
        { product_id: furnitureId, document_name: "Furniture Durability Test Report", document_type: "Performance", file_url: "/api/dpp-export?format=pdf&product=demo-office-chair", file_size: "510 KB", language: "EN / ZH", uploaded_by: "greanlean admin", version: "v1.0" },
        { product_id: furnitureId, document_name: "REACH SVHC Screening Report", document_type: "Chemical", file_url: "/api/chemical-document?type=svhc&product=demo-office-chair", file_size: "460 KB", language: "EN", uploaded_by: "greanlean admin", version: "v1.0" },
      ]);
