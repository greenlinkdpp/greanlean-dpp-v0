...
const BATTERY_CORE_FIELDS: Array<Omit<FieldTemplate, "id" | "profile_key">> = [
  ...
  { module_key: "performance_durability", field_key: "state_of_health", field_label: "State of health SoH", field_label_zh: "健康状态 SoH", data_type: "number", unit: "%", required: false, evidence_required: false, visibility_level: "public", requirement_level: "standard_ready", regulation_reference: "BatteryPass-Ready Longlist v1.3 dynamic performance data", access_rights: "restricted/public depending on role", granularity_level: "item", validation_hint: "Dynamic state-of-health value where battery management data is available.", sort_order: 63 },
  { module_key: "performance_durability", field_key: "state_of_charge", field_label: "State of charge SoC", field_label_zh: "荷电状态 SoC", data_type: "number", unit: "%", required: false, evidence_required: false, visibility_level: "public", requirement_level: "standard_ready", regulation_reference: "BatteryPass-Ready Longlist v1.3 dynamic performance data", access_rights: "restricted/public depending on role", granularity_level: "item", validation_hint: "Dynamic state-of-charge value where available.", sort_order: 64 },
