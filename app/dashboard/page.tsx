  ...
  const t =
    locale === "zh"
      ? {
          ...
          consumer: "消费者透明化与可访问性",
          consumerDesc: "补充品牌故事、可持续说明、护理、维修、包装、回收指引、术语解释和下载文件。",
      ...
      : {
          ...
          consumer: "Consumer transparency and accessibility",
          consumerDesc: "Add brand story, sustainability notes, care, repair, packaging, recycling guidance, glossary and downloads.",
